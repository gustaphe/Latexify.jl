...
using .MyModule
t = MyModule.MyType([:A, :B, 3.0], [1.0, 2, 3])
...
double_vec = MyModule.MyDoubleVec(
    [MyModule.MyFloat(x) for x in 1:4], [MyModule.MyFloat(x) for x in 8:11]
)
...
tup2 = MyModule.MyDoubleTup((1.0, 3), (2.0, 4.0))
