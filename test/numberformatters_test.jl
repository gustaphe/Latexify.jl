...
@test FancyNumberFormatter() ==
    FancyNumberFormatter(4) ==
    FancyNumberFormatter("%.4g", "\\cdot") ==
    FancyNumberFormatter("%.4g", s"\g<mantissa> \\cdot 10^{\g<sign_exp>\g<mag_exp>}")
...
@test FancyNumberFormatter(
    "%.5E",
    s"\g<mantissa>,\g<before_dp>,\g<sign>,\g<before_dp_nosign>,\g<after_dp>,\g<e_or_E>,\g<raw_exp>,\g<sign_exp>,\g<mag_exp>",
)(
    x
) == "-2.34729,-2,-,2,34729,E,+08,,8"
